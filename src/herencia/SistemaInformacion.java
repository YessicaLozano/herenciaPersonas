...
el empleado y el estudiante para mostrar los cálculos de cada uno de los respectivos procesos 
implementadospor cada clase */
...
//métodos de lectura de datos
    do { 
        opcion = sistemaInformacion.leerDatoTipoEntero("Ingrese la opción 1 para procesar los datos del empleado, 2 para procesar los datos de un estudiante, y 3 para salir: ");
        if (opcion == 1){
...
//Mostramos el reporte de datos
            ...
            //opcion Estudiante agregada al menú 
        } else if (opcion == 2){
            JOptionPane.showMessageDialog(null, "Procesando datos del estudiante");
            Estudiante manejadorEstudiente = new Estudiante();
            manejadorEstudiente = manejadorEstudiente.ingresarDatosEstudiante();
            manejadorEstudiente.imprimirReporteNotasEstudiante();
        } else if (opcion == 3) {
